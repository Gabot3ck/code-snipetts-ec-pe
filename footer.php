  ...
  <footer class="footer">
    <div class="footer__top">
      <div class="footer__top__brand">
        <img class="logo_img" src="https://www.tiendascanavini.pe/wp-content/uploads/2024/11/logo_footer.webp" alt="Logo Scanavini">
      ...
      <div class="footer__top__contact">
        ...
        <div class="wrapper-contact-for-customer">
          ...
          <div class="wrapper-body-contact-for-customer">
            ...
            <p>Atención al cliente <br>
              <a href="https://wa.me/51983487908">+51 983 487 908</a> <br>
              <a href="tel:+5112045444">+51 1 204 5444</a>
            </p>
          </div>
        </div>
        ...
        <div class="wrapper-contact-for-customer">
          ...
          <div class="wrapper-body-contact-for-customer">
            <p class="title-contact-for-customer">Atención exclusiva para Canal Ferretero</p>
            <p>
              * Lima: <a href="https://wa.me/51983487669"> +51 983 487 669</a> <br>
              * Provincia: <a href="https://wa.me/51965124479"> +51 965 124 479</a>
            </p>
          </div>
        </div>
      ...
      <div class="footer__top__marketing">
        <div>
          ...
          <div class="d-flex gap-2 justify-content-around justify-content-xs-center">
            <a href="https://www.tiktok.com/@scanavini.peru" aria-label="Síguenos en TikTok - Scanavini Perú" target="_blank">
              <i class="bi bi-tiktok"></i>
            </a>
            <a href="https://www.instagram.com/scanavini_peru" aria-label="Síguenos en Instagram - Scanavini Perú" target="_blank">
              <i class="bi bi-instagram"></i>
            </a>
            <a href="https://www.facebook.com/ScanaviniPeru" aria-label="Visita nuestra página de Facebook - Scanavini Perú" target="_blank">
              <i class="bi bi-facebook"></i>
            </a>
            <a href="https://www.linkedin.com/company/scanavini-comercial-sac" aria-label="Conéctate con nosotros en LinkedIn - Scanavini" target="_blank">
        ...
        <div class="claims-book-container">
          <a href="https://reclamaciones.tiendascanavini.pe" target="_blank">
            <img src="https://www.tiendascanavini.pe/wp-content/uploads/2025/04/libro-de-reclamaciones-virtual.png" alt="libro de reclamaciones virtual scanavini" class="img-fluid">
          </a>
        </div>
      </div>
